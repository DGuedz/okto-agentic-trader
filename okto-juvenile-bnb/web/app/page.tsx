...
export default function Home() {
  return (
    <main className="mx-auto max-w-6xl px-6 py-10 font-mono">
      ...
      <h1 className="my-3 text-4xl md:text-5xl">
        <LText en="OKTO — Sovereign Agentic Trading Infrastructure" pt="OKTO — Infraestrutura Agentic Trading Soberana" />
      </h1>
      <BiText
